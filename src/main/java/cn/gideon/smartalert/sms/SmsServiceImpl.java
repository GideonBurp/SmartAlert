...
import cn.gideon.smartalert.common.utils.RestClientUtils;
...
import static cn.gideon.smartalert.common.response.ResponseCode.SYSTEM_ERROR;
...
//    @DistributeLock(scene = "SEND_SMS", keyExpression = "#phoneNumber")
    ...
    public Result sendMsg(String phoneNumber, String code) {
        ...
        Result smsSendResponse = new Result();
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                smsSendResponse = Result.success();
            }
        } catch (Exception e) {
            logger.error("sendMsg error", e);
            smsSendResponse = Result.error(StringUtils.substring(e.toString(), 0, 1000));
        }
